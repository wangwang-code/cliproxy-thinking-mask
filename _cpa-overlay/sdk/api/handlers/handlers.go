...
// StreamingFirstEventTimeout returns how long CPA waits for the first valid
// upstream SSE event before treating the current upstream attempt as dead.
// Returning 0 disables the timeout (legacy indefinite wait).
