...
// StreamLimitMaxBytesMetadataKey carries the resolved upstream byte budget for
// a non-streaming request. Values <= 0 disable the cap.
const StreamLimitMaxBytesMetadataKey = "stream_limit_max_bytes"

// StreamLimitMaxDurationMetadataKey carries the resolved upstream wall-clock
// budget in milliseconds for a non-streaming request. Values <= 0 disable it.
const StreamLimitMaxDurationMetadataKey = "stream_limit_max_duration_ms"

// StreamLimitMaxContentCharsMetadataKey carries the resolved content-character
// budget for a non-streaming request. Values <= 0 disable it.
const StreamLimitMaxContentCharsMetadataKey = "stream_limit_max_content_chars"
